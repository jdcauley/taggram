...
class Instagram {
  ...
  public function getApiCallback() {
    ...
    /**
* Pagination by next_max_id
*
* @param int $next_max_id Instagram next_max_id returned by a method
* @param int $limit Limit number of images per request
* @return mixed
*/
  public function paginationById($next_max_id, $limit=0) {
    if (true === is_string($next_max_id) ) {
      return $this->_makeCall('users/self/media/recent', true, array('max_id' => $next_max_id, 'count' => $limit));
    } else {
